...
object StationRepository {
    val stations = listOf(
        ...
        RadioStation("Mix Megapol GBG", "https://tx-bauerse.sharp-stream.com/http_live.php?i=mixmegapolgbg_instream_se_mp3", accentColor = 0xFFE53935, logoRes = R.drawable.logo_mix_megapol)
    )
}
